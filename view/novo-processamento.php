...
<main class="dash_main">
    ...
    <section class='dash_view' style='display: block'>
        ...
        <div class="dash_view_home">
            <div class="">
                <h1 class='dash_view_activities_title icon-plus'>NOVO PROCESSAMENTO</h1>
                <p class='dash_view_activities_newclasses_title'>Envie um novo arquivo para processar</p>
            </div>
            <div class="inlineForm">
                <form class="defaultForm basic_form" action="" method="post">
                    <input type="hidden" name="callback" value="Login">
                    <input type="hidden" name="callback_action" value="processingNew">
                    <label class=''>
                        <span>Selecione um arquivo:</span>
                        <input type="file" id="myFile" class='input' name="drefile" value="" required>
                    </label>
                    <label class=''>
                        <span>Nome do processamento:</span>
                        <input type="text" name="dre_title" class='input' value="" placeholder="Salvar como: " >
                    </label>
